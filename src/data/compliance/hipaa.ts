export const HIPAA_MAPPING = {
  ...
  controls: [
    { id: '164.308(a)(1)', description: 'Security Management Process', findingIds: ['known-malicious', 'supply-chain-low-trust', 'known-vulnerability-critical'] },
    ...
    { id: '164.312(c)(1)', description: 'Integrity Controls', findingIds: ['server-mutation', 'server-mutation', 'duplicate-server'] },
