export const PCI_DSS_MAPPING = {
  ...
  controls: [
    ...
    { id: 'Req 6', description: 'Protect Systems Against Attacks', findingIds: ['known-vulnerability-critical', 'known-vulnerability-high', 'known-malicious', 'supply-chain-low-trust'] },
    ...
    { id: 'Req 12', description: 'Support Information Security Policies', findingIds: ['server-mutation', 'server-mutation', 'typosquat-detection'] }
  ]
};
